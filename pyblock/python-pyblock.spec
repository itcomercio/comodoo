...
* Tue Apr 20 2010 Hans de Goede <hdegoede@redhat.com> - 0.47-1
- Don't create a mapping for extended partitions (#583484)

* Fri Feb 12 2010 Hans de Goede <hdegoede@redhat.com> - 0.46-1
- When a stripe set is missing disks it is not degraded, but broken,
  add a check for broken sets

* Wed Feb 03 2010 Peter Jones <pjones@redhat.com> - 0.45-5
- Switch from %%define to %%global

* Wed Jan 20 2010 Hans de Goede <hdegoede@redhat.com> - 0.45-4
- Rebuild for new dmraid again, this time with the right dmraid in
  the buildroot

* Wed Jan 20 2010 Hans de Goede <hdegoede@redhat.com> - 0.45-3
- Rebuild for new dmraid

* Thu Jan  7 2010 Hans de Goede <hdegoede@redhat.com> - 0.45-2
